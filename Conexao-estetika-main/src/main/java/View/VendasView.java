...
public class VendasView extends JPanel {
    ...
    public VendasView(
        ...
        Titulo.setFont(new java.awt.Font("Arial", 0, 24));
        ...
        btnNovaVenda.setFont(new java.awt.Font("Arial", 0, 12));
        ...
        btnAbrirCaixa.setFont(new java.awt.Font("Arial", 0, 12));
        ...
        btnFecharCaixa.setFont(new java.awt.Font("Arial", 0, 12));
        ...
        btnSuprimento.setFont(new java.awt.Font("Arial", 0, 12));
        ...
        btnSangria.setFont(new java.awt.Font("Arial", 0, 12));
        ...
        lblSubtotal.setFont(new java.awt.Font("Arial", 0, 24));
        lblSubtotal.setForeground(new java.awt.Color(31, 111, 95));
        lblSubtotal.setText("Subtotal: R$");

        lblSubtotaValor.setFont(new java.awt.Font("Arial", 0, 24));
        ...
        btnFinalizarVenda.setFont(new java.awt.Font("Arial", 0, 12));
        ...
        lblCliente.setFont(new java.awt.Font("Arial", 0, 14));
        lblCliente.setForeground(new java.awt.Color(30, 30, 30));
        lblCliente.setText("Cliente:");

        lblProduto.setFont(new java.awt.Font("Arial", 0, 14));
        ...
        txtProduto.setFont(new java.awt.Font("Arial", 0, 12));
        ...
        tblItenVenda.setModel(new javax.swing.table.DefaultTableModel(
                new Object[][]{},
                new String[]{"Id", "Nome", "Quantidade", "Preço Un.", "Valor Total"}
        ) {
            ...
            if (vendaController.buscarCaixaAberto() != null) {
                if (vendaAtual != null && !vendaAtual.getItens().isEmpty()) {
                    JOptionPane.showMessageDialog(null,
                            "Finalize ou cancele a venda em andamento antes de fechar o caixa!",
