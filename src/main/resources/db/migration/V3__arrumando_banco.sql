...
DROP TYPE status_venda CASCADE;
DROP TYPE forma_pagamento CASCADE;
DROP TYPE status_caixa CASCADE;
DROP TYPE tipo_movimento CASCADE;
DROP TYPE status_conta CASCADE;
