...
public class FinanceiroPanel extends JPanel {
    ...
    private void buildUI() {
        add(buildListagemCard(), BorderLayout.CENTER);
    }
        ...
        Runnable refresh = () -> {
            ...
            for (ContaPagar c : contaPagarService.listar()) {
                ...
                model.addRow(new Object[]{
                        ...
                        c.getFornecedor() != null
                                ? c.getFornecedor().getNome()
                                : "-",

                        c.getDescricao(),

                        c.getDataEmissao() != null
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    financeiroService.receberConta(
                            conta,
                            caixa,
                            usuarioLogado
                    );
    ...
    private JPanel buildTabLayout(JTable table, Runnable refresh) {
        ...
        JButton refreshBtn =
                MenuPrincipalView.createOutlineButton("↻ Atualizar");
        ...
        scroll.setBorder(
                BorderFactory.createLineBorder(
                        MenuPrincipalView.BORDER_COLOR
                )
        );
